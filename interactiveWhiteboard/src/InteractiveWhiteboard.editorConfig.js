...
export function getProperties(values, defaultProperties, target) {
    ...
    */
	...
	if (values.allowResize === "no_resize") {
        hidePropertyIn(defaultProperties, values, "restrictResize");
    }
	
	if (values.autoUpdate === "manual_update") {
        hidePropertyIn(defaultProperties, values, "updateInterval");
		hidePropertyIn(defaultProperties, values, "keepTools");
    }
	
	if (values.autoUpdate === "auto_update") {
        hidePropertyIn(defaultProperties, values, "snapshotSave");
		hidePropertyIn(defaultProperties, values, "snapshotLoad");
    }
